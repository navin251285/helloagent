# MCP Tools & Resources Demo (HTTP + API Key)

This folder mirrors 5_http_server, but adds a simple API key check.
...
The server listens on http://127.0.0.1:3000 and requires header `X-API-Key: demo-key`.
