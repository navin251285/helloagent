# MCP Tools & Resources Demo (HTTP)

This folder mirrors 4_tools_resource, but the MCP server is HTTP-based instead of stdio.
...
The server listens on http://127.0.0.1:3000 and responds to a JSON-RPC POST at `/`.
